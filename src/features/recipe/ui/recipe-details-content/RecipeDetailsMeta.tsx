    ...
    <div className="mt-5 flex flex-wrap items-center justify-between gap-4">
      <div>
        <div className="flex items-center gap-2">
          <RecipeCardBadge>{recipe?.cuisineType}</RecipeCardBadge>

          <RecipeCardBadge Icon={Flame}>{recipe?.calories}ккал</RecipeCardBadge>

          <RecipeCardBadge Icon={Clock4}>{recipe?.cookTime}мин</RecipeCardBadge>
      ...
      <div className="flex items-center gap-1">
        <Image
          src={recipe?.author.profile?.photo || ''}
