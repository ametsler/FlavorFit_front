        ...
        <div className="ml-[130px] flex items-start justify-between gap-6">
          <div className="min-w-0">
            <h2 className="text-4xl leading-none font-black tracking-[-0.02em] italic">
              У вас есть потрясающий рецепт?
            </h2>

            <p className="mt-2 text-sm text-white/80">
              Поделитесь и засияйте! Ваш рецепт вполне может стать следующим
              хитом!
            </p>
      ...
      <div className="flex flex-col justify-between rounded-2xl bg-white px-5 py-4">
        ...
        <div className="mt-6 flex items-end justify-between gap-4">
          <div className="flex items-end gap-2">
            ...
            <span className="text-black/45">добавлено</span>
          </div>
